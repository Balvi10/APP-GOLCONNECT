...
export function TopBar({ onBack, right, title = 'GOLCONNECT' }) {
  return (
...
export function BottomNav({ active, onNavigate, variant = 'jugador' }) {
...
export function Modal({ visible, onClose, children, maxWidth = 420 }) {
  return (
